...
public class ComputeTax {
	public static void main(String[] args) {
		...
		System.out.print("(0-singlefiler, 1-married jointly or qualifying widow(er), 2-married separately, 3-head of " + 
		...
		else if (status == 2) { //Compute tax for maried sepatately
			if (income <= 8350)
				tax = income * 0.1;
			else if (income <= 33950)
				tax = 8350 * 0.1 + (income - 8350) * 0.15;
